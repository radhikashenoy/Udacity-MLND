...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.epsilon = 1.0/(self.t**2 - self.alpha*self.t)#for improved learning
    ...
    def get_maxQ(self, state):
        ...
        #initially assign maxQ .Then replace it by a more valid value
        maxQ = -999
